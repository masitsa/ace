            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-lg-6 control-label">Category Name</label>
                        <div class="col-lg-6">
                    ...
                    <!-- Category Parent -->
                    <div class="form-group">
                        <label class="col-lg-6 control-label">Category Parent</label>
                        <div class="col-lg-6">
                ...
                <div class="col-md-6">
                    <!-- Activate checkbox -->
                    <div class="form-group">
                        <label class="col-lg-6 control-label">Activate Category?</label>
                        <div class="col-lg-6">
